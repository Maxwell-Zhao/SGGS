...
from utils.camera_utils import orbit_camera, OrbitCamera
...
class GaussianModel:
    ...
    def __init__(self, cfg):
        ...
        self.cam = OrbitCamera(512, 512, r=2, fovy=49.1)
    ...
    def training_setup(self, training_args):
        ...
        # self._objects_dc.requires_grad_(True)
    ...
    def load_ply(self, path):
        ...
        self._objects_dc = nn.Parameter(
            torch.tensor(objects_dc, dtype=torch.float, device="cuda").transpose(1, 2).contiguous().requires_grad_(
                True))
        self.frozen_labels = torch.zeros((self.get_xyz.shape[0]), device="cuda")
